...
using DecisionTree.CMS.MultiTenancy;
            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<CMSDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}DecisionTree.CMS.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<CMSDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}DecisionTree.CMS.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<CMSApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}DecisionTree.CMS.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<CMSApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}DecisionTree.CMS.Application"));
            });
        }
    }
